...
!(function (t, e) {
  ...
  var t = Object.defineProperty,
    ...
    r = {};
  function n(t, e) {
    "string" != typeof e && (e = n.defaultChars);
    const s = (function (t) {
      let e = r[t];
      if (e) return e;
      e = r[t] = [];
  ...
  var s = {};
  function i(t, e, r) {
    ("string" != typeof e && ((r = e), (e = i.defaultChars)),
      void 0 === r && (r = !0));
    const n = (function (t) {
      let e = s[t];
      if (e) return e;
    ...
    for (let s = 0, i = t.length; s < i; s++) {
      ...
      if (
        ...
        if (e >= 55296 && e <= 56319 && s + 1 < i) {
          const e = t.charCodeAt(s + 1);
          if (e >= 56320 && e <= 57343) {
            ((o += encodeURIComponent(t[s] + t[s + 1])), s++);
            continue;
          }
        }
        o += "%EF%BF%BD";
      } else o += encodeURIComponent(t[s]);
    }
    return o;
  }
  function o(t) {
  ...
  ((u.prototype.parse = function (t, e) {
    ...
    if (
      ...
      (e || o || i.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
        ((s = "//" === i.substr(0, 2)),
        !s || (o && g[o]) || ((i = i.substr(2)), (this.slashes = !0))),
      !g[o] && (s || (o && !k[o])))
    ) {
      let t,
        e,
    ...
    const u = i.indexOf("#");
    -1 !== u && ((this.hash = i.substr(u)), (i = i.slice(0, u)));
    const a = i.indexOf("?");
    return (
      -1 !== a && ((this.search = i.substr(a)), (i = i.slice(0, a))),
      i && (this.pathname = i),
      k[r] && this.hostname && !this.pathname && (this.pathname = ""),
      this
    );
  }),
    (u.prototype.parseHost = function (t) {
      let e = a.exec(t);
      (e &&
        ((e = e[0]),
  ...
  function R(t) {
    return (
      (t >= y.UPPER_A && t <= y.UPPER_F) || (t >= y.LOWER_A && t <= y.LOWER_F)
    );
  }
  function N(t) {
    return (
  ...
  var P = class {
    ...
    write(t, e) {
      switch (this.state) {
        case M.EntityStart:
          return t.charCodeAt(e) === y.NUM
            ? ((this.state = M.NumericStart),
              (this.consumed += 1),
              this.stateNumericStart(t, e + 1))
            : ((this.state = M.NamedEntity), this.stateNamedEntity(t, e));
        case M.NumericStart:
    ...
    stateNumericStart(t, e) {
      return e >= t.length
        ? -1
        : (32 | t.charCodeAt(e)) === y.LOWER_X
          ? ((this.state = M.NumericHex),
            (this.consumed += 1),
            this.stateNumericHex(t, e + 1))
          : ((this.state = M.NumericDecimal), this.stateNumericDecimal(t, e));
    }
    ...
    stateNamedEntity(t, e) {
      ...
      let n = r[this.treeIndex],
        s = (n & I.VALUE_LENGTH) >> 14;
      for (; e < t.length; e++, this.excess++) {
        const i = t.charCodeAt(e);
        if (
          ((this.treeIndex = Z(r, n, this.treeIndex + Math.max(1, s), i)),
          this.treeIndex < 0)
        )
          return 0 === this.result ||
            (this.decodeMode === T.Attribute && (0 === s || N(i)))
            ? 0
            : this.emitNotTerminatedNamedEntity();
        if (
          ((n = r[this.treeIndex]), (s = (n & I.VALUE_LENGTH) >> 14), 0 !== s)
        ) {
          if (i === y.SEMI)
    ...
    emitNamedEntityData(t, e, r) {
      ...
      return (
        this.emitCodePoint(1 === e ? n[t] & ~I.VALUE_LENGTH : n[t + 1], r),
  ...
  var Y = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
    K = new RegExp(Y.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source, "gi"),
    tt = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
  function et(t, e) {
    if (35 === e.charCodeAt(0) && tt.test(e)) {
      const r =
        "x" === e[1].toLowerCase()
  ...
  function ct(t) {
    return st.test(t) ? t.replace(it, ut) : t;
  }
  var at = /[.?*+^$[\]\\(){}|-]/g;
  function lt(t) {
    return t.replace(at, "\\$&");
  ...
  function kt(t) {
    let e = 0;
    for (; e < t.length && gt(t.charCodeAt(e)); e++);
    let r = t.length - 1;
    for (; r >= e && gt(t.charCodeAt(r)); r--);
    return t.slice(e, r + 1);
  }
  var Dt = { mdurl: E, ucmicro: z };
  function Ct(t, e, r) {
    let n, s, i, o;
    const u = t.posMax,
      c = t.pos;
  ...
  function yt(t, e, r) {
    ...
    return (
      e === s ||
        0 !== o ||
        ((i.str = nt(t.slice(e, s))), (i.pos = s), (i.ok = !0)),
      i
    );
  }
  function Et(t, e, r, n) {
    ...
    for (; i < r; ) {
      if (((s = t.charCodeAt(i)), s === o.marker))
        return ((o.pos = i + 1), (o.str += nt(t.slice(e, i))), (o.ok = !0), o);
      if (40 === s && 41 === o.marker) return o;
      (92 === s && i + 1 < r && i++, i++);
    }
    return ((o.can_continue = !0), (o.str += nt(t.slice(e, i))), o);
  }
  var At = e({
      parseLinkDestination: () => yt,
      parseLinkLabel: () => Ct,
      parseLinkTitle: () => Et,
    }),
    bt = {};
  ...
  ((bt.code_inline = function (t, e, r, n, s) {
    const i = t[e];
    return "<code" + s.renderAttrs(i) + ">" + ct(i.content) + "</code>";
  }),
    (bt.code_block = function (t, e, r, n, s) {
      const i = t[e];
      return (
        "<pre" +
        s.renderAttrs(i) +
    ...
    (bt.fence = function (t, e, r, n, s) {
      const i = t[e],
        o = i.info ? nt(i.info).trim() : "";
      let u,
        c = "",
        a = "";
      if (o) {
      ...
      if (
        ((u = (r.highlight && r.highlight(i.content, c, a)) || ct(i.content)),
        0 === u.indexOf("<pre"))
      )
        return u + "\n";
      if (o) {
    ...
    (bt.hardbreak = function (t, e, r) {
      return r.xhtmlOut ? "<br />\n" : "<br>\n";
    }),
    (bt.softbreak = function (t, e, r) {
      return r.breaks ? (r.xhtmlOut ? "<br />\n" : "<br>\n") : "\n";
    }),
    (bt.text = function (t, e) {
      return ct(t[e].content);
    }),
    (bt.html_block = function (t, e) {
      return t[e].content;
    }),
    (bt.html_inline = function (t, e) {
      return t[e].content;
    }),
    (Ft.prototype.renderAttrs = function (t) {
      ...
      for (n = "", e = 0, r = t.attrs.length; e < r; e++)
        n += " " + ct(t.attrs[e][0]) + '="' + ct(t.attrs[e][1]) + '"';
      return n;
    }),
    ...
    (xt.prototype.__find__ = function (t) {
    ...
    (xt.prototype.at = function (t, e, r) {
    ...
    (xt.prototype.before = function (t, e, r, n) {
    ...
    (xt.prototype.after = function (t, e, r, n) {
      const s = this.__find__(t),
        i = n || {};
      if (-1 === s) throw new Error("Parser rule not found: " + t);
    ...
    (xt.prototype.push = function (t, e, r) {
      const n = r || {};
      (this.__rules__.push({ name: t, enabled: !0, fn: e, alt: n.alt || [] }),
        (this.__cache__ = null));
    }),
    (xt.prototype.enable = function (t, e) {
      Array.isArray(t) || (t = [t]);
      const r = [];
      return (
    ...
    (xt.prototype.enableOnly = function (t, e) {
      (Array.isArray(t) || (t = [t]),
    ...
    (xt.prototype.disable = function (t, e) {
      Array.isArray(t) || (t = [t]);
      const r = [];
      return (
        t.forEach(function (t) {
  ...
  function Rt(t) {
    ...
    for (let r = t.length - 1; r >= 0; r--) {
      const n = t[r];
      ("text" !== n.type || e || (n.content = n.content.replace(Mt, $t)),
          ...
          for (let r = 0, n = e.length; r < n; r++) {
            ...
            for (let i = n.length - 1; i >= 0; i--) {
              ...
              if ("link_close" !== o.type) {
                if (
                  ("html_inline" === o.type &&
                    (qt(o.content) && s > 0 && s--, Bt(o.content) && s++),
        ...
        if (t.md.options.typographer)
          for (e = t.tokens.length - 1; e >= 0; e--)
            "inline" === t.tokens[e].type &&
              (It.test(t.tokens[e].content) && Rt(t.tokens[e].children),
              Lt.test(t.tokens[e].content) && Nt(t.tokens[e].children));
      },
    ],
    [
      "smartquotes",
      function (t) {
        if (t.md.options.typographer)
          for (let e = t.tokens.length - 1; e >= 0; e--)
            "inline" === t.tokens[e].type &&
              Pt.test(t.tokens[e].content) &&
              jt(t.tokens[e].children, t);
      },
    ],
    [
      "text_join",
      function (t) {
        ...
        for (let i = 0; i < s; i++) {
          ...
          const t = n[i].children,
            s = t.length;
          for (e = 0; e < s; e++)
            "text_special" === t[e].type && (t[e].type = "text");
          for (e = r = 0; e < s; e++)
            "text" === t[e].type && e + 1 < s && "text" === t[e + 1].type
  ...
  ((Ht.prototype.process = function (t) {
    ...
    (Ht.prototype.State = wt),
    (Vt.prototype.push = function (t, e, r) {
      const n = new vt(t, e, r);
      return (
        (n.block = !0),
        r < 0 && this.level--,
        (n.level = this.level),
    ...
    (Vt.prototype.skipSpaces = function (t) {
      for (let e = this.src.length; t < e && ht(this.src.charCodeAt(t)); t++);
      return t;
    }),
    (Vt.prototype.skipSpacesBack = function (t, e) {
      if (t <= e) return t;
      for (; t > e; ) if (!ht(this.src.charCodeAt(--t))) return t + 1;
      return t;
    }),
    (Vt.prototype.skipChars = function (t, e) {
      for (let r = this.src.length; t < r && this.src.charCodeAt(t) === e; t++);
      return t;
    }),
    (Vt.prototype.skipCharsBack = function (t, e, r) {
      if (t <= r) return t;
      for (; t > r; ) if (e !== this.src.charCodeAt(--t)) return t + 1;
      return t;
    }),
    (Vt.prototype.getLines = function (t, e, r, n) {
      if (t >= e) return "";
      ...
      for (let i = 0, o = t; o < e; o++, i++) {
        ...
        for (
          ...
          if (ht(e)) 9 === e ? (t += 4 - ((t + this.bsCount[o]) % 4)) : t++;
          else {
  ...
  function Jt(t, e) {
    ...
    return (42 !== s && 45 !== s && 43 !== s) ||
      (n < r && !ht(t.src.charCodeAt(n)))
      ? -1
      : n;
  }
  function Qt(t, e) {
    ...
    return s < n && ((i = t.src.charCodeAt(s)), !ht(i)) ? -1 : s;
  }
  var Xt = new RegExp(
      "^(?:<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^\"'=<>`\\x00-\\x20]+|'[^']*'|\"[^\"]*\"))?)*\\s*\\/?>|<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>|\x3c!---?>|\x3c!--(?:[^-]|-[^-]|--[^>])*--\x3e|<[?][\\s\\S]*?[?]>|<![A-Za-z][^>]*>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>)",
    ),
    Yt = new RegExp(
  ...
  var te = [
    [
      ...
      function (t, e, r, n) {
        ...
        if (124 !== u && 45 !== u && 58 !== u && !ht(u)) return !1;
        if (45 === o && ht(u)) return !1;
        for (; i < t.eMarks[s]; ) {
          const e = t.src.charCodeAt(i);
          if (124 !== e && 45 !== e && 58 !== e && !ht(e)) return !1;
          i++;
        }
        let c = Gt(t, e + 1),
          a = c.split("|");
        ...
        for (let g = 0; g < a.length; g++) {
          ...
          58 === t.charCodeAt(t.length - 1)
            ? l.push(58 === t.charCodeAt(0) ? "center" : "right")
            : 58 === t.charCodeAt(0)
              ? l.push("left")
              : l.push("");
        }
        if (((c = Gt(t, e).trim()), -1 === c.indexOf("|"))) return !1;
        ...
        for (let g = 0; g < a.length; g++) {
          ...
          l[g] && (e.attrs = [["style", "text-align:" + l[g]]]);
        ...
        return (
          m && (t.push("tbody_close", "tbody", -1), (m[1] = s)),
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        for (t.parentType = "list"; c < r; ) {
          ...
          const _ = [c, 0];
          ((u.map = _), l && (u.info = t.src.slice(o, p - 1)));
          const D = t.tight,
            C = t.tShift[c],
            y = t.sCount[c],
            E = t.listIndent;
          ...
          if (A) break;
          if (l) {
            if (((p = Qt(t, c)), p < 0)) break;
            o = t.bMarks[c] + t.tShift[c];
          } else if (((p = Jt(t, c)), p < 0)) break;
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        let m,
          _ = t.md.helpers.parseLinkTitle(c, s, i);
        for (; _.can_continue; ) {
          const e = u(o);
          if (null === e) break;
          ((c += e),
            ...
            (i = c.length),
            o++,
            (_ = t.md.helpers.parseLinkTitle(c, s, i, _)));
        }
        for (
          s < i && d !== s && _.ok
            ? ((m = _.str), (s = _.pos))
            : ((m = ""), (s = p), (o = f));
          s < i && ht(c.charCodeAt(s));
        )
          s++;
        if (s < i && 10 !== c.charCodeAt(s) && m)
          for (m = "", s = p, o = f; s < i && ht(c.charCodeAt(s)); ) s++;
        if (s < i && 10 !== c.charCodeAt(s)) return !1;
        const g = _t(c.slice(1, a));
        return (
          !!g &&
          (n ||
            (void 0 === t.env.references && (t.env.references = {}),
            void 0 === t.env.references[g] &&
              (t.env.references[g] = { title: m, href: h }),
            (t.line = o)),
          !0)
        );
      },
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        let o = t.src.slice(s, i),
          u = 0;
        for (; u < Kt.length && !Kt[u][0].test(o); u++);
        if (u === Kt.length) return !1;
        if (n) return Kt[u][2];
        let c = e + 1;
        const a = Kt[u][1].test("");
        if (!Kt[u][1].test(o))
    ...
    [
      ...
      function (t, e, r) {
        ...
        const c = kt(t.getLines(e, u, t.blkIndent, !1));
        t.line = u + 1;
    ...
    [
      ...
      function (t, e, r) {
        ...
        const o = kt(t.getLines(e, i, t.blkIndent, !1));
  ...
  function ee() {
    ...
    for (let t = 0; t < te.length; t++)
      this.ruler.push(te[t][0], te[t][1], { alt: (te[t][2] || []).slice() });
  }
  function re(t, e, r, n) {
    ((this.src = t),
      (this.env = r),
  ...
  ((ee.prototype.tokenize = function (t, e, r) {
    ...
    (ee.prototype.parse = function (t, e, r, n) {
      if (!t) return;
      const s = new this.State(t, e, r, n);
      this.tokenize(s, s.line, s.lineMax);
    }),
    (ee.prototype.State = Vt),
    (re.prototype.pushPending = function () {
      const t = new vt("text", "", 0);
      return (
    ...
    (re.prototype.push = function (t, e, r) {
    ...
    (re.prototype.scanDelims = function (t, e) {
      const r = this.posMax,
    ...
    (re.prototype.Token = vt));
  var se = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;
  var ie = [];
  for (let tr = 0; tr < 256; tr++) ie.push(0);
  function oe(t, e) {
    let r;
    const n = [],
      s = e.length;
  ...
  var ue = {
    ...
    postProcess: function (t) {
      ...
      oe(t, t.delimiters);
      for (let n = 0; n < r; n++)
        e[n] && e[n].delimiters && oe(t, e[n].delimiters);
    },
  };
  function ce(t, e) {
  ...
  var ae = {
    ...
    postProcess: function (t) {
      ...
      ce(t, t.delimiters);
      for (let n = 0; n < r; n++)
        e[n] && e[n].delimiters && ce(t, e[n].delimiters);
    },
  };
  var le =
      /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
    he = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
  var pe = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
    fe = /^&([a-z][a-z0-9]{1,31});/i;
  function de(t) {
    const e = {},
      r = t.length;
    if (!r) return;
  ...
  var me = [
      [
        ...
        function (t, e) {
          let r = t.pos;
          for (; r < t.posMax && !ne(t.src.charCodeAt(r)); ) r++;
          return (
            r !== t.pos &&
      ...
      [
        ...
        function (t, e) {
          ...
          for (r++; r < s && ht(t.src.charCodeAt(r)); ) r++;
          return ((t.pos = r), !0);
        },
      ],
      [
        ...
        function (t, e) {
          ...
          if (32 === s) {
            if (!e) {
              ...
              ((e.content = "\\"), (e.markup = "\\"), (e.info = "escape"));
            }
            return ((t.pos = r), !0);
          }
          let i = t.src[r];
          ...
          if (!e) {
            const e = t.push("text_special", "", 0);
            (s < 256 && 0 !== ie[s] ? (e.content = i) : (e.content = o),
              (e.markup = o),
              (e.info = "escape"));
          }
          return ((t.pos = r + 1), !0);
      ...
      [
        ...
        function (t, e) {
          ...
          if (d < h && 40 === t.src.charCodeAt(d)) {
            for (
              a = !1, d++;
              d < h && ((r = t.src.charCodeAt(d)), ht(r) || 10 === r);
              d++
            );
            if (d >= h) return !1;
            if (
      ...
      [
        ...
        function (t, e) {
          ...
          if (((i = d + 1), i < p && 40 === t.src.charCodeAt(i))) {
            for (
              i++;
              i < p && ((r = t.src.charCodeAt(i)), ht(r) || 10 === r);
              i++
            );
            if (i >= p) return !1;
            for (
      ...
      [
        ...
        function (t, e) {
          ...
          if (
            ...
            return !1;
          const i = t.src.slice(n).match(Xt);
          if (!i) return !1;
          if (!e) {
      ...
      [
        ...
        function (t, e) {
          ...
          if (35 === t.src.charCodeAt(r + 1)) {
            const n = t.src.slice(r).match(pe);
            if (n) {
              if (!e) {
                const e =
                    "x" === n[1][0].toLowerCase()
            ...
            const n = t.src.slice(r).match(fe);
            if (n) {
              const r = ((s = n[0]), j(s, T.Strict));
              if (r !== n[0]) {
                if (!e) {
                  const e = t.push("text_special", "", 0);
    ...
    _e = [
      [
        ...
        function (t) {
          ...
          de(t.delimiters);
          for (let n = 0; n < r; n++)
            e[n] && e[n].delimiters && de(e[n].delimiters);
        },
      ],
  ...
  function ge() {
    this.ruler = new xt();
    for (let t = 0; t < me.length; t++) this.ruler.push(me[t][0], me[t][1]);
    this.ruler2 = new xt();
    for (let t = 0; t < _e.length; t++) this.ruler2.push(_e[t][0], _e[t][1]);
  }
  function ke(t) {
    return (
      Array.prototype.slice.call(arguments, 1).forEach(function (e) {
  ...
  function Ce(t) {
    return "[object Function]" === De(t);
  }
  function ye(t) {
    return t.replace(/[.?*+^$[\]\\(){}|-]/g, "\\$&");
  }
  ((ge.prototype.skipToken = function (t) {
    const e = t.pos,
    ...
    (ge.prototype.tokenize = function (t) {
      const e = this.ruler.getRules(""),
        r = e.length,
        n = t.posMax,
        s = t.md.options.maxNesting;
    ...
    (ge.prototype.parse = function (t, e, r, n) {
      const s = new this.State(t, e, r, n);
      this.tokenize(s);
    ...
    (ge.prototype.State = re));
  var Ee = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 };
  var Ae = {
      "http:": {
  ...
  function Fe(t) {
    const e = (t.re = (function (t) {
        ...
        return (
          ...
          (e.src_auth = `(?:(?:(?!${e.src_ZCc}|[@/\\[\\]()]).){1,50}@)?`),
          (e.src_port =
            "(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?"),
          (e.src_host_terminator = `(?=$|${r}|${e.src_ZPCc})(?!${t["---"] ? "-(?!--)|" : "-|"}_|:\\d|\\.-|\\.(?!$|${e.src_ZPCc}))`),
          (e.src_path =
            `(?:[/?#](?:(?!${e.src_ZCc}|${r}|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!${e.src_ZCc}|\\]).)*\\]|\\((?:(?!${e.src_ZCc}|[)]).)*\\)|\\{(?:(?!${e.src_ZCc}|[}]).)*\\}|\\"(?:(?!${e.src_ZCc}|["]).)+\\"|\\'(?:(?!${e.src_ZCc}|[']).)+\\'|\\'(?=${e.src_pseudo_letter}|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!${e.src_ZCc}|[.]|$)|` +
            (t["---"] ? "\\-(?!--(?:[^-]|$))(?:-*)|" : "\\-+|") +
            `,(?!${e.src_ZCc}|$)|;(?!${e.src_ZCc}|$)|\\!+(?!${e.src_ZCc}|[!]|$)|\\?(?!${e.src_ZCc}|[?]|$))+|\\/)?`),
          (e.src_email_name =
          ...
          (e.src_domain =
            "(?:" +
            e.src_xn +
            `|(?:${e.src_pseudo_letter})|(?:${e.src_pseudo_letter}(?:-|${e.src_pseudo_letter}){0,61}${e.src_pseudo_letter}))`),
    ...
    (t.onCompile(),
      ...
      (e.email_fuzzy_global = RegExp(n(e.tpl_email_fuzzy), "ig")),
      (e.link_fuzzy = RegExp(n(e.tpl_link_fuzzy), "i")),
      (e.link_fuzzy_global = RegExp(n(e.tpl_link_fuzzy), "ig")),
      (e.link_no_ip_fuzzy = RegExp(n(e.tpl_link_no_ip_fuzzy), "i")),
      (e.link_no_ip_fuzzy_global = RegExp(n(e.tpl_link_no_ip_fuzzy), "ig")),
    ...
    ((t.__compiled__ = {}),
      Object.keys(t.__schemas__).forEach(function (e) {
        ...
        if (((t.__compiled__[e] = n), "[object Object]" === De(r)))
          return (
            !(function (t) {
              return "[object RegExp]" === De(t);
            })(r.validate)
              ? Ce(r.validate)
  ...
  function ve(t, e) {
    ...
    (e ||
      ...
      Object.keys(r || {}).reduce(function (t, e) {
        return t || Ee.hasOwnProperty(e);
      }, !1) && ((e = t), (t = {}))),
      (this.__opts__ = ke({}, Ee, e)),
      (this.__schemas__ = ke({}, Ae, t)),
      (this.__compiled__ = {}),
      (this.__tlds__ = be),
  ...
  ((ve.prototype.add = function (t, e) {
    return ((this.__schemas__[t] = e), Fe(this), this);
  }),
    (ve.prototype.set = function (t) {
      return ((this.__opts__ = ke(this.__opts__, t)), this);
    }),
    (ve.prototype.test = function (t) {
      ...
      if (this.re.schema_test.test(t))
        for (
          ...
          if (this.testSchemaAt(t, e[2], r.lastIndex)) return !0;
      return (
        !!(
          this.__opts__.fuzzyLink &&
          this.__compiled__["http:"] &&
          t.search(this.re.host_fuzzy_test) >= 0 &&
          null !==
            t.match(
        ...
        !!(
          ...
          t.indexOf("@") >= 0 &&
          null !== t.match(this.re.email_fuzzy)
        )
      );
    }),
    (ve.prototype.pretest = function (t) {
      return this.re.pretest.test(t);
    }),
    (ve.prototype.testSchemaAt = function (t, e, r) {
      return this.__compiled__[e.toLowerCase()]
        ? this.__compiled__[e.toLowerCase()].validate(t, r, this)
        : 0;
    }),
    (ve.prototype.match = function (t) {
      const e = [],
        r = [],
        n = [],
        s = [];
      ...
      if (this.re.schema_test.test(t))
        for (
          ...
          ((o = this.testSchemaAt(t, i[2], u.lastIndex)),
            o &&
              r.push({
                schema: i[2],
                index: i.index + i[1].length,
                lastIndex: i.index + i[0].length + o,
              }));
      if (this.__opts__.fuzzyLink && this.__compiled__["http:"])
        for (
          u = this.__opts__.fuzzyIP
          ...
          n.push({
            schema: "",
            index: i.index + i[1].length,
            lastIndex: i.index + i[0].length,
          });
      if (this.__opts__.fuzzyEmail && this.__compiled__["mailto:"])
        for (
          u = this.re.email_fuzzy_global, u.lastIndex = 0;
          null !== (i = u.exec(t));
        )
          s.push({
            schema: "mailto:",
      ...
      let l = 0;
      for (;;) {
        const i = [r[a[0]], s[a[1]], n[a[2]]],
          o = c(c(i[0], i[1]), i[2]);
        if (!o) break;
        if ((o === i[0] ? a[0]++ : o === i[1] ? a[1]++ : a[2]++, o.index < l))
          continue;
        const u = new xe(t, o.schema, o.index, o.lastIndex);
        (this.__compiled__[u.schema].normalize(u, this),
          e.push(u),
          (l = o.lastIndex));
      }
      return e.length ? e : null;
    }),
    (ve.prototype.matchAtStart = function (t) {
      if (!t.length) return null;
    ...
    (ve.prototype.normalize = function (t) {
  ...
  var Ne = function (t) {
    ...
    Oe = function (t, e, r) {
      let n = 0;
      for (t = r ? Ie(t / 700) : t >> 1, t += Ie(t / e); t > 455; n += ze)
        t = Ie(t / 35);
      return Ie(n + (36 * t) / (t + 38));
    },
    Ze = function (t) {
      const e = [],
        r = t.length;
      ...
      o < 0 && (o = 0);
      for (let u = 0; u < o; ++u)
        (t.charCodeAt(u) >= 128 && Te("not-basic"), e.push(t.charCodeAt(u)));
      for (let u = o > 0 ? o + 1 : 0; u < r; ) {
        const o = n;
        for (let e = 1, s = ze; ; s += ze) {
          u >= r && Te("invalid-input");
          const o = Ne(t.charCodeAt(u++));
          (o >= ze && Te("invalid-input"),
            o > Ie((we - n) / e) && Te("overflow"),
            (n += o * e));
          const c = s <= i ? 1 : s >= i + 26 ? 26 : s - i;
          if (o < c) break;
          const a = ze - c;
          (e > Ie(we / a) && Te("overflow"), (e *= a));
        }
        const c = e.length + 1;
        ((i = Oe(n - o, c, 0 == o)),
          Ie(n / c) > we - s && Te("overflow"),
          (s += Ie(n / c)),
          (n %= c),
          e.splice(n++, 0, s));
      }
    ...
    je = function (t) {
      ...
      let n = 128,
        s = 0,
        i = 72;
      for (const c of t) c < 128 && e.push(Me(c));
      const o = e.length;
      let u = o;
      for (o && e.push("-"); u < r; ) {
        let r = we;
        ...
        const c = u + 1;
        (r - n > Ie((we - s) / c) && Te("overflow"),
          (s += (r - n) * c),
          (n = r));
        for (const a of t)
          if ((a < n && ++s > we && Te("overflow"), a === n)) {
            let t = s;
            for (let r = ze; ; r += ze) {
              ...
              const s = t - n,
                o = ze - n;
              (e.push(Me(Pe(n + (s % o), 0))), (t = Ie(s / o)));
            }
            (e.push(Me(Pe(t, 0))), (i = Oe(s, c, u === o)), (s = 0), ++u);
          }
        (++s, ++n);
      }
      return e.join("");
    ...
    Ue = function (t) {
      return $e(t, function (t) {
        return qe.test(t) ? "xn--" + je(t) : t;
      });
    },
    He = function (t) {
      return $e(t, function (t) {
        return Se.test(t) ? Ze(t.slice(4).toLowerCase()) : t;
      });
    },
    Ve = {
      default: {
    ...
    Ge = /^(vbscript|javascript|file|data):/,
    We = /^data:image\/(gif|png|jpeg|webp);/;
  function Je(t) {
    const e = t.trim().toLowerCase();
    return !Ge.test(e) || We.test(e);
  }
  var Qe = ["http:", "https:", "mailto:"];
  function Xe(t) {
    const e = D(t, !0);
    if (e.hostname && (!e.protocol || Qe.indexOf(e.protocol) >= 0))
      try {
        e.hostname = Ue(e.hostname);
      } catch (r) {}
    return i(o(e));
  }
  function Ye(t) {
    ...
    if (e.hostname && (!e.protocol || Qe.indexOf(e.protocol) >= 0))
      try {
        e.hostname = He(e.hostname);
      } catch (r) {}
    return n(o(e), n.defaultChars + "%");
  }
  function Ke(t, e) {
    ...
    (e || H(t) || ((e = t || {}), (t = "default")),
      ...
      (this.linkify = new ve()),
      (this.validateLink = Je),
      (this.normalizeLink = Xe),
      (this.normalizeLinkText = Ye),
      (this.utils = U),
      (this.helpers = W({}, At)),
      (this.options = {}),
      this.configure(t),
  ...
  return (
    (Ke.prototype.set = function (t) {
      return (W(this.options, t), this);
    }),
    (Ke.prototype.configure = function (t) {
      const e = this;
      if (H(t)) {
        const e = t;
        if (!(t = Ve[e]))
    ...
    (Ke.prototype.parse = function (t, e) {
      if ("string" != typeof t)
        throw new Error("Input data should be a String");
      const r = new this.core.State(t, this, e);
      return (this.core.process(r), r.tokens);
    }),
    (Ke.prototype.render = function (t, e) {
      return (
        (e = e || {}),
        this.renderer.render(this.parse(t, e), this.options, e)
      );
    }),
    (Ke.prototype.parseInline = function (t, e) {
      const r = new this.core.State(t, this, e);
      return ((r.inlineMode = !0), this.core.process(r), r.tokens);
    }),
    (Ke.prototype.renderInline = function (t, e) {
      return (
        (e = e || {}),
